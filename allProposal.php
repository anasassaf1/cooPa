			...
			<div class="bg-overlay">
				<div class="container" style="">
					<div class="intro-wrap" style="float: right; position: initial; margin-top: 300px;">
						<h1 class="intro-title">المشاريع المقترحة</h1>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="main container">
			...
			<div class="row blog-posts">
				<div id="content" class="col-lg-12">
					<div class="row">
						<?php if ($about['type'] == 5) 
							echo '<h4 style="color: red; text-align: right;">مقترحات المشاريع التي باللون الأحمر تدل على أنها لم تقيم بعد</h4>';
						?>
						<?php
							require_once "users.php";
							...
							$user = new User();
							$results = $user->allProposal();

							foreach ($results as $result) : ?>
							<?php if ($result['rate'] != NULL) : ?>
									...
									<article class="posts tag-fly tag-kids tag-location tag-planning tag-tickets tag-time-of-year tag-train tag-travel tag-vacation">
										<div class="card">
											<header class="entry-header">
												<?php
													$id_proposal = $result['id'];
													echo '<a href="proposalInfo.php?id='.$id_proposal.'" rel="bookmark">';
												?>
									...
									<article class="posts tag-fly tag-kids tag-location tag-planning tag-tickets tag-time-of-year tag-train tag-travel tag-vacation">
										<div class="card">
											<header class="entry-header">
												...
												?>
													<div class="entry-thumbnail" style="background-image: url(assets/images/blog-3-600x800.jpg)"> <img width="600" height="800" title="" alt="" src="assets/images/blog-placeholder-vertical.png"></div>
														<h2 class="entry-title" style="color: red">
															<?php echo $result['title'];?>
														</h2>
												</a>
											</header>
